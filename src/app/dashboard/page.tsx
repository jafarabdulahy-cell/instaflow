        ...
        <header className="safe-top px-4 pt-4">
          <div className="flex items-center justify-between gap-3 rounded-[28px] bg-white/80 px-3.5 py-3 shadow-[0_16px_45px_rgba(42,16,90,0.08)] ring-1 ring-[#E6E2F4] backdrop-blur-xl">
            <div className="relative flex h-11 w-11 items-center justify-center rounded-2xl bg-white text-[#2A105A] shadow-sm ring-1 ring-[#E6E2F4]">
              ...
              <span className="absolute -right-1 -top-1 grid h-5 min-w-5 place-items-center rounded-full bg-[#FF2D55] px-1 text-[11px] font-black text-white">
                3
              </span>
            </div>
            ...
            <div className="relative flex items-start justify-between gap-3">
              <div className="min-w-0 pt-2">
                ...
                <p className="mt-2 text-[12px] font-medium leading-6 text-white/86">
                  مدیریت هوشمند دایرکت و ارتباط با مشتریان
                </p>
        ...
        <section className="grid grid-cols-2 gap-3 px-4 pt-4">
          {stats.map((stat) => {
            ...
            return (
              <Card
                key={stat.label}
                className="overflow-hidden rounded-[24px] border-0 bg-white shadow-[0_14px_32px_rgba(42,16,90,0.08)] ring-1 ring-[#ECE8F6]"
              >
                <CardContent className="relative min-h-[118px] p-4">
                  <div className="flex items-start justify-between gap-2">
                    ...
                    <div className="text-right">
                      ...
                      <p className="mt-2 text-3xl font-black leading-none tracking-tight text-[#17112A]">
                        {stat.value}
                      </p>
        ...
        <section className="px-4 pt-6">
          ...
          {!data?.accounts.length ? (
            <div className="rounded-[26px] border border-dashed border-[#D8D2E8] bg-white/72 px-5 py-7 text-center shadow-[0_16px_38px_rgba(42,16,90,0.06)]">
              ...
              <p className="mx-auto mt-2 max-w-[300px] text-[12px] font-medium leading-6 text-[#6D6780]">
                برای دریافت DM و Webhook، پیج اینستاگرام خود را متصل کنید.
              </p>
            </div>
          ) : (
            <div className="space-y-3">
              {data.accounts.map((account, index) => (
                <Card
                  key={account.id}
                  className="rounded-[22px] border-0 bg-white shadow-[0_14px_30px_rgba(42,16,90,0.07)] ring-1 ring-[#ECE8F6]"
                >
                  <CardContent className="flex items-center gap-3 p-3.5">
                    ...
                    <div className="min-w-0 flex-1 text-right">
                      <div className="flex items-center justify-end gap-2">
                        ...
                        <p className="truncate text-[14px] font-black text-[#17112A]">
                          {account.name || "رستوران شانشین"}
                        </p>
                      </div>
                      <p className="mt-1 truncate text-[12px] font-medium text-[#6D6780]" dir="ltr">
                        @{account.username}
                      </p>
                    </div>
